...
function B2bCoupon() {
  ...
  return (
    <div style={{ padding: '20px', maxWidth: '760px', margin: '0 auto' }}>
      <h2>🎟️ 쿠폰 대상 회원 선택 ({user.name || '사장'}님)</h2>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px', flexWrap: 'wrap', gap: '10px' }}>
        ...
        <button
          ...
          style={{
            ...
            fontWeight: 'bold',
            color: '#fff',
            backgroundColor: selectedCount === 0 ? '#ccc' : '#ef6c00',
            border: 'none',
            borderRadius: '6px',
      ...
      {loading ? (
        ...
        <p style={{ color: '#888', padding: '20px', textAlign: 'center', border: '1px dashed #ccc', borderRadius: '8px' }}>
          회원 데이터가 없습니다. (이탈 예측 배치 실행 후 표시됩니다)
        </p>
      ) : (
        <div style={{ overflowX: 'auto' }}>
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '14px' }}>
            <thead style={{ background: '#f5f5f5' }}>
              <tr>
                <th style={{ padding: '8px', width: '48px', textAlign: 'center' }}>
                  <input
                    type="checkbox"
                ...
                <th style={{ padding: '8px', textAlign: 'left' }}>ID (전화번호)</th>
